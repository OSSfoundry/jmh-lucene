...
# Lucene JMH Benchmark Module

![](https://user-images.githubusercontent.com/448788/137606913-007e3190-cd2a-4626-809a-7bccb9205088.png)

**_`profile, approximate luceneutil, compare and introspect`_**
...
- [](#)
  ...
  - [Continued Documentation](#continued-documentation)
    - [📚 JMH and Writing Lucene Benchmarks](#-jmh-and-writing-lucene-benchmarks)
...
- **Luceneutil:** a single benchmark and supporting code to approximate the search performance done nightly by Luceneutil.
...
### 📚 JMH and Writing Lucene Benchmarks

- 📒 The Random Data API
- [docs/random-data-gen.md](docs/random-data-gen.md)
- 📒 Writing Lucene JMH Benchmarks
- [docs/writing-jmh-benchmarks.md](docs/writing-jmh-benchmarks.md)
- 📒 JMH Profilers
