 ...
 *
 * <p>You need a lucene 6.x core jar, then do this: javac -cp /path/to/lucene-core.jar
 * DiskUsage.java java -cp /path/to/lucene-core.jar:. DiskUsage
 * /elasticserach/data/elasticsearch/nodes/0/indices/whatever/0/index
 */
